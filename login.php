...
$projectId = (isset($sbconfig['ProjectId'])) ? $sbconfig['ProjectId'] : "";
$instanceName = (isset($sbconfig['InstanceName'])) ? $sbconfig['InstanceName'] : "";
...
if (($adapter != "sqlite" && $projectId && $instanceName && $user && ($pass || $_POST)) || ($adapter == "sqlite" && $database)) {
	...
	if ($adapter == "sqlite") {
		...
		try {
			$connString = "$adapter:unix_socket=/cloudsql/$projectId:$instanceName" . (!empty($database) ? ";dbname=$database":'');
...
<html xmlns="http://www.w3.org/1999/xhtml" version="-//W3C//DTD XHTML 1.1//EN" xml:lang="en">
	...
	<div id="loginform">
		...
		if ($ua && $ie && $ieVer < 7) {
			...
			<tr>
			<td class="field"><?php echo __("Project ID"); ?>:</td>
			<td>
			  <input type="text" class="text" name="PROJECT_ID" value="<?php echo $projectId; ?>" />
			  example: project-name
			 </td>
			</tr>
			<tr>
			<td class="field"><?php echo __("Instance Name"); ?>:</td>
			<td>
			  <input type="text" class="text" name="INSTANCE_NAME" value="<?php echo $instanceName; ?>" />
			  example: project-name:<span style="font-weight: bold;">sqldb</span>
			 </td>
			</tr>
			<tr>
			...
			<td>
			  <input type="password" class="text" name="PASS" id="PASS" />
			  <em>password not required for root user.</em>
			</td>
			</tr>
			</table>
			...
			<tr>
			<td class="field"></td>
			<td><input type="submit" class="inputbutton" value="<?php echo __("Login"); ?>" /></td>
			</tr>
			</table>
			<?php
	...
	<div style="margin: 0 auto; width: 338px;"><a href="https://cloud.google.com/appengine/docs/php/cloud-sql/" target="_blank">Cloud SQL Docs - Connection Examples</a></div>
	</div>
